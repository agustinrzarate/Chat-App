...
import { Auth, initialStateSignIn } from '../../models/Auth'
...
const Authentication = () => {
  ...
  return (
    <div>
      {
        authType === 'SIGN_IN' ? <SingInContainer toggleVariant={toggleVariant}/> : <SingUpContainer toggleVariant={toggleVariant}/>
      }
    </div>
  )
}
